...
namespace ML.Controls
{
    ...
    /// @Author: Linh.Tran
    /// </summary>
    public partial class frmLoadingScreenStyle2 : Form
    {
        #region Properties
        //The type of form to be displayed as the splash screen.
        private static frmLoadingScreenStyle2 _splashForm;
        ...
        private static void DoShowSplash(Point point, Size size)
        {
            if (_splashForm == null)
            {
                _splashForm = new frmLoadingScreenStyle2();
