...
{
    public partial class ucStationInfo_230905_2 : UserControl
    {
        #region Properties
        ...
        public bool IsSelected
        {
            ...
            set
            {
                ...
                CommonFunctions.Invoke(this, new Action(() =>
                {
                    if (_IsSelected)
                    {
                        gStationStatus.Font = new System.Drawing.Font(gStationStatus.Font.FontFamily, (gStationStatus.Font.Size + 4), FontStyle.Bold);
                        ...
                        tblMainActiveFailed.BackColor = Color.FromArgb(204, 247, 255);//Color.FromArgb(136, 211, 225);//SystemColors.GradientActiveCaption;
                    }
                    else
                    {
                        ...
                        tblMainExportTotal.BackColor =
                        tblMainActiveSuccess.BackColor =
                        tblMainActiveFailed.BackColor = Color.WhiteSmoke;
                    }
                }));
            }
        }
