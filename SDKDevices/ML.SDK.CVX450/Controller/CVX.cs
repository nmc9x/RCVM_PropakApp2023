...
namespace ML.SDK.CVX450.Controller
{
    ...
    public class CVX : IDisposable
    {
        ...
        private Thread listenThreadLoop;
        public static string[] resultReceivedData;
        public CVX()
        {
            listenThreadLoop = new Thread(AlwayListenData);
            listenThreadLoop.IsBackground = true;
            listenThreadLoop.Start();
        }

        private void AlwayListenData()
        {
            try
            {
                while (true)
        ...
        public CVXResponseCode ReadRunSetupMode(out bool isRunMode)
        {
            ...
            var errorCode = (CVXResponseCode)Convert.ToInt32(resSplit[2]);   // Return error code
            return errorCode;
        }
        ...
        /// <returns>Error code</returns>
        public CVXResponseCode Trigger(out string[] resultData)
        {
        ...
        /// <returns>Error code</returns>
        public CVXResponseCode ImageRegistration(int cameraNo, int referenceNo, out string[] result)
        {
            string res = sendMessage("BS," + cameraNo + "," + 0 + "\r");
